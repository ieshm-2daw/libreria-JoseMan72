    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genero', models.CharField(choices=[('N', 'Novela'), ('C', 'Cuento'), ('P', 'Poesía'), ('T', 'Teatro'), ('O', 'Otros')], max_length=1)),
                ('isbn', models.IntegerField(max_length=13)),
                ('resumen', models.TextField()),
                ('portada', models.ImageField(blank=True, null=True, upload_to='portadas/')),
                ('disponibilidad', models.CharField(choices=[('D', 'Disponible'), ('P', 'Prestado'), ('E', 'En proceso de prestamo')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('P', 'Prestado'), ('D', 'Devuelto')], default='P', max_length=1)),
